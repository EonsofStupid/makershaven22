...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-[#1a1a1a]">
      ...
      {/* Navigation */}
      <nav className="fixed top-0 left-0 right-0 z-50 bg-[#1A1F2C]/40 backdrop-blur-xl border-b border-[#41f0db]/20">
            ...
            <div className="flex items-center space-x-6">
              <div className="relative group">
                <input
                  type="text"
                  placeholder="Search..."
                  className="w-64 px-4 py-2 bg-[#222]/20 border border-[#41f0db]/20 rounded-lg text-white 
              ...
              <button className="p-2 rounded-full bg-[#222]/20 border border-[#41f0db]/20 
      ...
      >
        <div className="text-center max-w-4xl mx-auto space-y-8">
          ...
          >
            ...
            >
              <img 
                src="/lovable-uploads/8bf77016-aea3-48bd-8212-e42940268b03.png"
                alt="Innovation"
      ...
      <motion.section 
        ...
        className="relative z-10 min-h-screen bg-[#1A1F2C]/50 backdrop-blur-xl py-32"
      >
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {Array.from({ length: 6 }).map((_, i) => (
              <motion.div
                ...
                className="bg-[#222]/40 border border-[#41f0db]/20 rounded-xl p-6 hover:border-[#41f0db]/50 
